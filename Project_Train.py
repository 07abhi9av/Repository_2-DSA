...
stations = ["DELHI", "GWALIOR", "CHENNAI", "BANGALORE", "BOMBAY", "BALLIA"]
destination = ["JAMMU"]
...
while r != 0:
    ...
    def BOOK_TICKETS():
        ...
        tic = int(input("Enter Seat Number(0,72): "))
        ...
        if boardingStation == "DELHI":
            ...
            print(
                "*YOUR TICKET FROM BOMBAY TO JAMMU IS GETTING PROCESSED PLEASE ENTER THE FOLLOWING DETAILS*"
            )
            if lst[tic - 1] == tic:
                fname1 = str(input("Enter Your First Name: \n"))
                lname1 = str(input("Enter Your Last Name: \n"))
